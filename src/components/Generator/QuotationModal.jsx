      ...
      isPage ? "max-w-6xl mx-auto my-6 border border-white/10" : "max-w-4xl"
        ...
        <div className="p-6 space-y-5 max-h-[75vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="bg-white/5 p-3 rounded-lg flex justify-between items-center">
            ...
            <span className="text-base sm:text-lg font-bold text-blue-400">{formatCurrency(totalAmount, activeWorkbench?.country)}</span>
          </div>
        ...
        <div className="sticky bottom-0 z-30 p-4 sm:p-5 border-t border-white/10 bg-[#1a1a1a]/95 backdrop-blur-md shadow-2xl flex flex-col-reverse sm:flex-row justify-between gap-3 shrink-0">
          ...
          <button onClick={handleSendToTrade} className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-lg text-xs flex items-center justify-center cursor-pointer">
