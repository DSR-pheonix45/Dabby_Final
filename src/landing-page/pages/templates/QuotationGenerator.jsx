...
export default function QuotationGenerator() {
  ...
  const handleExportPDF = () => {
    const doc = generateStandardDocumentPDF({
      documentType: "QUOTATION",
      docNumber: quotationData.quotationNumber,
      docDate: quotationData.date,
      dueDate: quotationData.expiryDate,
      senderName: quotationData.senderName,
      senderAddress: quotationData.senderAddress,
      senderGstin: quotationData.senderGstin,
      senderMobile: quotationData.senderMobile,
      ...
      placeOfSupply: quotationData.placeOfSupply,
      ...
      authorisedSignatory: quotationData.authorisedSignatory
    });

    doc.save(`${quotationData.quotationNumber}_Quotation.pdf`);
  };
      ...
      <div className={`border-b ${theme === "dark" ? "border-white/10 bg-[#111827]" : "border-gray-200 bg-white"} sticky top-0 z-30 shadow-sm print:hidden`}>
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-xl font-bold">Quotation Generator</h1>
              <p className="text-xs opacity-60">Generate structured, professional Quotation & Estimate PDFs</p>
            </div>
          </div>
            ...
            <div className="flex rounded-lg bg-gray-200 dark:bg-white/10 p-1">
              <button
                ...
                className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all ${
                  activeTab === "edit" ? "bg-blue-600 text-white shadow" : "text-gray-600 dark:text-gray-300"
                }`}
              >
                Form Editor
              </button>
              <button
                ...
                className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all ${
                  activeTab === "preview" ? "bg-blue-600 text-white shadow" : "text-gray-600 dark:text-gray-300"
                }`}
              >
                Document Preview
              </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className={`p-6 rounded-2xl border ${theme === "dark" ? "bg-[#111827] border-white/10" : "bg-white border-gray-200"} shadow-sm`}>
                <h2 className="text-base font-bold border-b pb-2 mb-4 text-blue-400">1. Quotation Details</h2>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold mb-1 opacity-70">Quotation No.</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold mb-1 opacity-70">Quotation Date</label>
                    <input
                      type="date"
                      name="date"
              ...
              <div className={`p-6 rounded-2xl border ${theme === "dark" ? "bg-[#111827] border-white/10" : "bg-white border-gray-200"} shadow-sm space-y-3`}>
                <h2 className="text-base font-bold border-b pb-2 mb-4 text-blue-400">2. Your Business Details (Header)</h2>
                <div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      name="senderMobile"
                      value={quotationData.senderMobile}
                      onChange={handleInputChange}
                      className={`w-full p-2.5 rounded-lg border text-sm ${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-gray-50 border-gray-300"}`}
                    />
                  </div>
              ...
              <div className={`p-6 rounded-2xl border ${theme === "dark" ? "bg-[#111827] border-white/10" : "bg-white border-gray-200"} shadow-sm space-y-4`}>
                <h2 className="text-base font-bold border-b pb-2 text-blue-400">3. Billing & Shipping Details</h2>
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    value={quotationData.placeOfSupply}
                    onChange={handleInputChange}
                    className={`w-full p-2.5 rounded-lg border text-sm ${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-gray-50 border-gray-300"}`}
                  />
                </div>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <input
                    ...
                    value={quotationData.shipToName}
                    onChange={handleInputChange}
                    className={`w-full p-2.5 rounded-lg border text-sm ${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-gray-50 border-gray-300"}`}
                  />
                  <input
              ...
              {/* Bank Details & Terms */}
              <div className={`p-6 rounded-2xl border ${theme === "dark" ? "bg-[#111827] border-white/10" : "bg-white border-gray-200"} shadow-sm space-y-4`}>
                <h2 className="text-base font-bold border-b pb-2 text-blue-400">5. Bank Details & Terms</h2>
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      value={quotationData.bankDetails.name}
                    ...
                    <input
                      ...
                      value={quotationData.bankDetails.ifsc}
                      onChange={handleBankChange}
                      className={`p-2 rounded border text-xs ${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-gray-50 border-gray-300"}`}
                    />
                    <input
                      ...
                      value={quotationData.bankDetails.accountNo}
                      onChange={handleBankChange}
                      className={`p-2 rounded border text-xs ${theme === "dark" ? "bg-white/5 border-white/10 text-white" : "bg-gray-50 border-gray-300"}`}
                    />
                    <input
            ...
            <div className="lg:col-span-6 sticky top-24 self-start">
              <div className="mb-2 flex items-center justify-between">
                ...
                <span className="text-[11px] text-blue-400 font-semibold">Updates real-time</span>
              </div>
