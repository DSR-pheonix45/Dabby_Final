...
DOC_TYPE_MAP: Dict[str, Tuple[str, str]] = {
    ...
    "customer_payment":      ("PAYMENT_SNIPPET", "issuer"),
    "customer_payment_receipt": ("PAYMENT_SNIPPET", "issuer"),
    "receipt":               ("PAYMENT_SNIPPET", "issuer"),
    "vendor_payment":        ("PAYMENT_SNIPPET", "recipient"),
    ...
    "expense_receipt":       ("PAYMENT_SNIPPET", "issuer"),
